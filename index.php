...
<div class="text-center">
        <h1 class="text-light"><b>CHECKER @TERRA.COM.BR</b></h1>
        <div class="text-center ">
</br>
</br>
		<center><h class="text-light"><b><span class=''>FORMATO: TESTE@TERRA.COM.BR|SENHA123</span></b></h></center>
</br>
    ...
    <center>
        <div class="mb-3">
            ...
            <a href="../../" class="btn btn-primary btn-min-width mr-1 mb-1">LIMPAR</a>
        </div>
    </center>
